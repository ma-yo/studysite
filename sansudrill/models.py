...
class NgPattern(models.Model):
    ...
    left_small_input = models.CharField(max_length=3)
    right_input = models.CharField(max_length=3)
    right_small_input = models.CharField(max_length=3)
    ...
    def get_hash(self):
        val = self.drill_type + self.left_input + self.left_small_input + self.right_input + self.right_small_input + self.answer_select \
